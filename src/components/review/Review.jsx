...
const Review = () => {
    return (
        <div>
            ...
            <Testimony name='Njoku Ifeanyi' status='COO Permuta' rep={ify2}>
            ...
            <Testimony name='Celia Almedia' status='CEO Mailcharm' rep={p5} >
            ...
            <Testimony name='Celia Almedia' status='CEO Mailcharm' rep={p3}>
                <p>Proin sed libero enim sed faucibus turpis. At imperdiet dui accumsan sit amet nulla facilisi morbi tempus. 
                    Ut sem nulla pharetra diam sit amet nisl. Enim nunc faucibus a pellentesque sit amet.
                    Sed turpis tincidunt id aliquet risus feugiat in ante metus.</p>
            </Testimony>
            <Testimony name='Celia Almedia' status='CEO Mailcharm' rep={p6}>
                <p>Proin sed libero enim sed faucibus turpis. At imperdiet dui accumsan sit amet nulla facilisi morbi tempus. 
                    Ut sem nulla pharetra diam sit amet nisl. Enim nunc faucibus a pellentesque sit amet.
                    Sed turpis tincidunt id aliquet risus feugiat in ante metus.</p>
            </Testimony>
